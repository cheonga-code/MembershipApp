...
public class AdminOrderlistCompleteActivity extends AdminOrderNavActivity {
...
//        setContentView(R.layout.activity_admin_orderlist_complete);

        //앱바 제목 변경
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("관리자 주문 관리");
        //네비 색상 변경
        bottomNavigationView.setItemBackground(getResources().getDrawable(R.color.colorSub));
    ...
    public void recyclerInit(){
        ...
        adminOrderlistAdapter.activityName = "orderComplete";
    }
        ...
        applicationClass.databaseReference.child("AdminOrderlist")
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        applicationClass.makeLog("///AdminOrderlistCompleteActivity : Timedata -> onChildAdded()///");
                        //초기화
//                        adminOrderlistAdapter.timeKeyList.clear();
                    ...
                    public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        applicationClass.makeLog("///AdminOrderlistCompleteActivity : Timedata -> onChildChanged()///");
                    }
                    @Override
...
//        adminOrderlistAdapter.orderInfoDTOArrayList.clear();
        ...
        applicationClass.databaseReference.child("AdminOrderlist").child(timeKeyData)
                .addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        applicationClass.makeLog("///AdminOrderlistCompleteActivity : Orderlistdata -> onChildAdded()///");
                        //초기화
//                        adminOrderlistAdapter.orderInfoDTOArrayList.clear();
                        ...
                        //주문 삳태가 '완료' 인 데이터만 저장하기
                        if(orderInfoDTO.getOrderState().matches("완료")){
                    ...
                    @Override
                    public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                        applicationClass.makeLog("///AdminOrderlistCompleteActivity : Orderlistdata -> onChildChanged()///"); }
                    @Override
                    public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {}
                    @Override
                    public void onChildMoved(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {}
    ...
    int getContentViewId() {
        return R.layout.activity_admin_orderlist_complete;
    }

    @Override
    int getNavigationMenuItemId() {
        return R.id.bottomNavAdminOrder03;
    }
}
